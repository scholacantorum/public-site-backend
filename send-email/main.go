// send-email sends an email from the admin@scholacantorum.org account.  The
// command line arguments are the destination addresses.  The headers and body
// of the message are given through standard input.  The body is interpreted as
// HTML, and is wrapped in Schola styles and logo.
package main
